...
if selected == 'Pregnancy Risk Prediction':
    ...
    content = ("Predicting the risk in pregnancy involves analyzing several parameters, including age, "
               "blood sugar levels, blood pressure, and other relevant factors. By evaluating these parameters, "
               "we can assess potential risks and make informed predictions regarding the pregnancy's health.")
